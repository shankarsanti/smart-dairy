    ...
    <body class="main-body">
      <header>
        <div class="box-area">
              ...
              <img src="../frontend/images/NATURE-ONE-DAIRY-CORPORATE-LOGO-01.png" alt="" class="lg"></a>
              <span class="title">Dairy Management</span>
              <a href="../frontend/loginpage.html" class="login"><i class="fas fa-sign-in-alt"></i>Login</a>
        </div>
</header>
            ...
            <div class="banner-area">
             <div class="menu">
                      <ul>
                        ...
                        <li><a href="../frontend/aboutus.html"><i class="fas fa-info-circle"></i>About Us</a></li>
                        <li><a href="../frontend/gallery.html"><i class="far fa-images"></i>Gallery</a></li>
            ...
            <div class="section" id="aboutus">
                <div class="products">
                <h3> Our Products</h3>
                 <img src="../frontend/images/products.jpg" alt="image">
                 <br>
                ...
                <div class="products">
                <h3>Our Aim </h3>
                 <img src="../frontend/images/aim.jpg">
                 <br>
                ...
                <div class="products">
                <h3>Working</h3>
                 <img src="../frontend/images/working.png" alt="image">
                 <br>
                 <p> let"s start<P>
                 <a href="#">Read More</a>
                </div>
