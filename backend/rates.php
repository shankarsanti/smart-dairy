...
$demoData = false;
$rates = [
    ['id' => 1, 'milk_type' => 'Cow Milk', 'rate_per_liter' => 45, 'quality_bonus' => 2, 'effective_date' => '2025-06-01'],
    ['id' => 2, 'milk_type' => 'Buffalo Milk', 'rate_per_liter' => 55, 'quality_bonus' => 3, 'effective_date' => '2025-06-01'],
    ['id' => 3, 'milk_type' => 'Mixed Milk', 'rate_per_liter' => 48, 'quality_bonus' => 2.5, 'effective_date' => '2025-06-01'],
];
$demoData = true;
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Rates & Settings - Dairy System</title>
...
<body>
    <div class="page-wrapper">
        ...
        <div class="main-content">
            <div class="topbar"><h2 class="page-title"><i class="fas fa-percentage"></i> Rates & Settings</h2><div style="text-align: right;"><strong><?php echo htmlspecialchars($user['name']); ?></strong></div></div>
            <?php if ($demoData): ?>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i>
                    <span>This is sample rate data to preview the module. Configure actual rates to replace it.</span>
                </div>
            <?php endif; ?>
                    ...
                    <tbody>
                        <?php foreach ($rates as $rate): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($rate['milk_type']); ?></td>
                                <td><?php echo htmlspecialchars($rate['rate_per_liter']); ?></td>
                                <td><?php echo htmlspecialchars($rate['quality_bonus']); ?></td>
                                <td><?php echo htmlspecialchars($rate['effective_date']); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
