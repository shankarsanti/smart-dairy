...
(11111, 'Demo User', '1234567890', 1000, 'staff', 'demo');
...
INSERT INTO `Dairy_products` (`produt_id`, `product_name`, `product_cost`) VALUES
(205, 'Curd 1L', 50),
(206, 'Ghee 1L', 400),
(207, 'Cheese 1Kg', 410),
(208, 'Butter 1Kg', 510),
(209, 'Milk Cow', 52.25),
(210, 'Milk Buffalo', 60.00);
...
CREATE TABLE `Dairy_customers` (
  ...
  `PR1` varchar(20) DEFAULT NULL,
  `PR2` varchar(20) DEFAULT NULL,
  `PR3` varchar(20) DEFAULT NULL,
  `PR4` varchar(20) DEFAULT NULL,
  `PR5` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `Dairy_customers` (`invoice_id`, `customer_name`, `customer_mobile`, `Total_cost`, `PR1`, `PR2`, `PR3`, `PR4`, `PR5`) VALUES
(1, 'Demo User', '9000000000', 620.25, '209', '205', '206', '207', '208'),
(2, 'Test Buyer', '9000000001', 170.00, '209', '205', NULL, NULL, NULL),
(3, 'Sample Customer', '9000000002', 400.00, '210', '206', NULL, NULL, NULL);
...
--
ALTER TABLE `Dairy_products`
  MODIFY `produt_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;

--
-- AUTO_INCREMENT for table `Dairy_customers`
--
ALTER TABLE `Dairy_customers`
  MODIFY `invoice_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
